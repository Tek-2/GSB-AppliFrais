...
class PdoGsb
{
    ...
    /**
     * Retourne les visiteurs qui ont une fiche de frais
     *
    ...
    public function majFraisForfait($idVisiteur, $mois, $lesFrais)
    {
     ...
     /*public function majFraisHorsForfait($idVisiteur, $mois, $date, $montant, $id, $libelle)
     {
         $dateHF = dateFrancaisVersAnglais($date);
            $requetePrepare = PdoGSB::$monPdo->prepare(
                ...
                . 'AND lignefraishorsforfait.libelle = :unLibelle'
    ...
    */
     ...
     public function majFraisHorsForfait($idVisiteur, $moisV, $date, $montant, $libelle) {
        $dateHF = dateFrancaisVersAnglais($date);
        $requetePrepare = PdoGSB::$monPdo->prepare(
            'UPDATE lignefraishorsforfait '
     ...
     */
    public function creeFHFReporté($idVisiteur, $mois, $libelle, $date, $montant){
                    //var_dump($idVisiteur,$leMois,$libelleHF,$dateHF,$montantHF);
            $dateFr = dateFrancaisVersAnglais($date);
            $requetePrepare = PdoGSB::$monPdo->prepare(
                "INSERT INTO lignefraishorsforfait "
                . "VALUES (null, :unIdVisiteur,:unMois,'$libelle', :uneDateFr,:unMontant)"
            );
            $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
            $requetePrepare->bindParam(':unMois', $mois, PDO::PARAM_STR);
    ...
    public function creeNouvellesLignesFrais($idVisiteur, $mois)
    {
        ...
        foreach ($lesIdFrais as $unIdFrais) {
            ...
            $requetePrepare->bindParam(
                ':idFrais',
                $unIdFrais['idfrais'], PDO::PARAM_STR );
            $requetePrepare->execute(); }  }
    ...
    public function majMontant($idVisiteur, $mois, $montant)
    {
        $requetePrepare = PdoGSB::$monPdo->prepare(
             'UPDATE ficheFrais '
            . 'SET montantvalide = montantvalide+:unMontant'
            . 'WHERE fichefrais.idvisiteur = :unIdVisiteur '
            . 'AND fichefrais.mois = :unMois'
            );
        $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
