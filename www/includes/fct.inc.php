...
/**
 * Enregistre dans une variable session les infos d'un visiteurcomptable
 *
...
/**
 * Retourne le mois precedent au mois selectionné en paramètre 
 *
 * @param String $date au format  jj/mm/aaaa
 *
 * @return String Mois au format aaaamm
...
function getMoisPrecedent($mois) {
    ...
    if (strlen($numMois) == 1) { //strlen verifie le nb de caracteres
        $numMois = '0' . $numMois;
    }
...
/**
 * Retourne les 12 derniers mois au format aaaamm selon le jour dans le mois
 *
 * @param String $date au format  jj/mm/aaaa
 *
 * @return String Mois au format aaaamm
 */
function getDouzeDerniersMois($mois) {
    $lesMois = array();
    for ($k = 1; $k <= 12; $k++) {
